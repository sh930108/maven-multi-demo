...
(function($) {
    ...
    function _d(_e) {
        ...
        cc.find(">div").each(function() {
            ...
            pp.panel({ collapsible: true, minimizable: false, maximizable: false, closable: false, doSize: false, collapsed: pp.attr("selected") != "true", onBeforeExpand: function() {
                ...
                var iframe = pp.panel("header").parent().find("iframe");
                clickMenu(iframe);
    ...
    function _13(_14, _15) {
        ...
        // 点击加载数据
	    var iframe = _17.panel("header").parent().find("iframe");
	    clickMenu(iframe);
...
(function($) {
    ...
    function _22f(_230, _231) {
        ...
        var tab = $("<li id='tab"+_231.receiveId+"'></li>");
    ...
    function _238(_239, _23a) {
        ...
        var elem = $(">div.tabs-header li[id="+_23a+"]", _239)[0];
        //$(">div.tabs-header li:has(a span:contains(\"" + _23a + "\"))", _239)[0];
        if (!elem) {
            return;
        }
    ...
    function _23e(_23f, _240) {
        if (_240) {
            var elem = $(">div.tabs-header li[id=tab"+_240+"]", _23f)[0];
            //$(">div.tabs-header li:has(a span:contains(\"" + _240 + "\"))", _23f)[0];
            if (elem) {
                $(elem).trigger("click");
            }
        } else {
    ...
    function _241(_242, _243) {
        return $(">div.tabs-header li[id=tab"+_243+"]", _242).length > 0;
        //$(">div.tabs-header li:has(a span:contains(\"" + _243 + "\"))", _242).length > 0;
    };
